...
public class UnblockUserCommandPost extends FrontCommand {
    private UserService userService;

    public UnblockUserCommandPost(ServletContext servletContext, HttpServletRequest servletRequest, HttpServletResponse servletResponse) {
