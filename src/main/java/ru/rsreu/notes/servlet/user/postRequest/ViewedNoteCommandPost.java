...
public class ViewedNoteCommandPost extends FrontCommand {
    private NoteService noteService;

    public ViewedNoteCommandPost(ServletContext servletContext, HttpServletRequest servletRequest, HttpServletResponse servletResponse) {
    ...
    public void execute() throws IOException, ServletException {
        ...
        noteService.saveUserNoteView(user.getUserId(), noteId);
