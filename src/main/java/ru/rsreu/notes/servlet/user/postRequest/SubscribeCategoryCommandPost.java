...
public class SubscribeCategoryCommandPost extends FrontCommand {
    private CategoryService categoryService;

    public SubscribeCategoryCommandPost(ServletContext servletContext, HttpServletRequest servletRequest, HttpServletResponse servletResponse) {
