...
public class UserProfileCommandGet extends FrontCommand {
    private SessionService sessionService;

    public UserProfileCommandGet(ServletContext servletContext, HttpServletRequest servletRequest, HttpServletResponse servletResponse) {
