...
public class ChangeUserCommandPost extends FrontCommand {
    private UserService userService;

    public ChangeUserCommandPost(ServletContext servletContext, HttpServletRequest servletRequest, HttpServletResponse servletResponse) {
