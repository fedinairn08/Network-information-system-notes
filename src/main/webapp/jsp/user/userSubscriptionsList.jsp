...
<html>
<head>
    <title>Список подписок на пользователей</title>
...
<div>
    ...
    <div class="userSubscriptionsList-container px-5">
        <div class="userSubscriptionsList-inner">
            <div class="userSubscriptionsList-title title">
                <div class="header-user dark-text">Список подписок на пользователей</div>
            </div>
            <br>
            <jsp:include page="userSubscriptionsListTable.jsp"/>
        </div>
    </div>
</div>
