...
<div>
    ...
    <div class="categoryList-container px-5">
        <div class="categoryList-inner">
            <div class="categoryList-title title">
                <div class="header-user dark-text">Список категорий</div>
            </div>
            <br>
            <jsp:include page="categoryListTable.jsp"/>
        </div>
    </div>
</div>
