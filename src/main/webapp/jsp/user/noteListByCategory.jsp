...
<div>
    ...
    <div class="noteListByCategory-container px-5">
        <div class="noteListByCategory-inner">
            <div class="noteListByCategory-title title">
                <div class="header-user dark-text">Список заметок</div>
            </div>
            <br>
            <jsp:include page="noteListByCategoryTable.jsp"/>
        </div>
    </div>
</div>
