...
<html>
<head>
    <title>Список подписок на категории</title>
...
<div>
    ...
    <div class="categorySubscriptionsList-container px-5">
        <div class="categorySubscriptionsList-inner">
            <div class="categorySubscriptionsList-title title">
                <div class="header-user dark-text">Список подписок на категории</div>
            </div>
            <br>
            <jsp:include page="categorySubscriptionsListTable.jsp"/>
        </div>
    </div>
</div>
