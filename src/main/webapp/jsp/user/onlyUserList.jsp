...
<div>
    ...
    <div class="onlyUserList-container px-5">
        <div class="onlyUserList-inner">
            <div class="onlyUserList-title title">
                <div class="header-user dark-text">Список пользователей</div>
            </div>
            <br>
            <jsp:include page="onlyUserListTable.jsp"/>
        </div>
    </div>
</div>
